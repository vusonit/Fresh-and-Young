    ...
    <section className="relative w-full h-[1080px] -mt-20 overflow-hidden bg-black">
      ...
      <div className="relative w-[1440px] h-full mx-auto">
        ...
        <h1
          ...
          style={{ left: 405, top: 200, width: 738 }}
        >
          PROJECTS
        </h1>
        ...
        >
          <Image
            src="/images/project-hero-base.png"
            alt=""
            width={1595}
            height={1994}
        ...
        <Image
          src="/images/project-hero-overlay.png"
          alt="Our Projects"
          width={1595}
          height={1994}
          className="absolute z-[3] left-1/2 -translate-x-1/2 pointer-events-none"
          style={{ top: -73, width: "max(1595px, 110.76vw)", height: "auto" }}
          priority
          quality={90}
        />
        ...
        <p
          ...
          style={{ left: 103, top: 363, width: 176 }}
        >
          Những dự án chỉn chu tôn vinh giá trị bền vững.
        </p>
      </div>
    </section>
  );
